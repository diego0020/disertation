...
The explore activity (Figure \ref{fig_use_case_explore}) can be achieved trough a combination of several analysis tasks.
\begin{itemize}
...
\begin{figure}
\centering
\includegraphics[width=0.95\textwidth]{braviz/BravizDeploy}
