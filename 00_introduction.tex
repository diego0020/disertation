...
In economics it is usual to see research (for example \autocite{}) based entirely on public data, like results from census or other government data. In fact most of the world governments are creating open data policies, that make important amounts of data available for anyone to explore.
