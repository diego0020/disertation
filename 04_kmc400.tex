...
\begin{figure}
    ...
    \begin{subfigure}{0.45\textwidth}
        \includegraphics[width=\textwidth]{kmc400/221}
    \end{subfigure}
    \begin{subfigure}{0.45\textwidth}
...
\begin{figure}
	\centering
		\includegraphics[width=\textwidth]{figures/kmc400/left caudate con fragility index in less than 1801 gr}
...
\begin{figure}
	\centering
		\includegraphics[width=\textwidth]{figures/kmc400/caudate parallel}
...
\begin{figure}
	\centering
		\includegraphics[width=\textwidth]{Detailed view of the outlier from figure \ref{fig_caudate_parallel}, it confirms that the strange behaviour exhibited is real and not a problem with the data.}
	\caption{}
