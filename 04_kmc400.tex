...
\begin{figure}
	\centering
	\begin{subfigure}{0.45\textwidth}
		\includegraphics[width=\textwidth, trim=400px 150px 350px 85px, clip]{kmc400/homunculo_pie}
		\caption{Abnormal}
	\end{subfigure}
	\begin{subfigure}{0.45\textwidth}
		\includegraphics[width=\textwidth, trim=400px 150px 350px 85px, clip]{kmc400/homunculo_pie_control}
		\caption{Control}
	\end{subfigure}
	\caption{llalalala}
...
\begin{figure}
	\centering
	\begin{subfigure}{0.45\textwidth}
		\includegraphics[width=\textwidth, trim=700px 400px 220px 150px, clip]{kmc400/wm_atrophy}
		\caption{Abnormal}
	\end{subfigure}
	\begin{subfigure}{0.45\textwidth}
		\includegraphics[width=\textwidth, trim=700px 400px 220px 150px, clip]{kmc400/wm_control}
		\caption{Control}
	\end{subfigure}
...
\begin{figure}
	\centering
	\begin{subfigure}{0.45\textwidth}
		\includegraphics[width=\textwidth, trim=1400px 0px 1400px 0px, clip]{kmc400/thick_skull}
		\caption{Abnormal}
	\end{subfigure}
	\begin{subfigure}{0.45\textwidth}
		\includegraphics[width=\textwidth, trim=1400px 0px 1400px 0px, clip]{kmc400/thick_skull_control}
		\caption{Control}
	\end{subfigure}
