...
\centering
	\begin{subfigure}{0.3\textwidth}
		\includegraphics[height=\textwidth, trim = 450pt 50pt 500pt 100pt, clip]{kmc400/thalamus_mri}
		\caption{T1}
	\end{subfigure}\hfill
	\begin{subfigure}{0.3\textwidth}
...
\begin{figure}
	\centering
	\subcaptionbox[0.45\textwidth]{Flair Image 	\label{fig_white_matter_lessions_a}}
		{\includegraphics[width=0.45\textwidth]{kmc400/wm_lessions}} \hfill
	\subcaptionbox[0.45\textwidth]{Plot of Griffiths and WASI scores 	\label{fig_white_matter_lessions_b}}
		{\includegraphics[width=0.45\textwidth]{kmc400/wm_gri_wasi}}
